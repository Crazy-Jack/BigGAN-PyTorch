...
def plot_channel_activation(intermediates, img_index, img, experiment_name, config, state_dict):
    ...
    target_img_name = '{}/{}/img_{}_iter_{}_target_.jpg'.format(config['evals_root'],
                                                    experiment_name, img_index, state_dict['itr'])
    ...
    for layer_index in intermediates:
        ...
        activation_visual_name = '%s/%s/img_%s_iter_%s_plot_inter_activation_layer_%s.jpg' % (config['evals_root'],
                                                    experiment_name, img_index, state_dict['itr'], layer_index)
        ...
        # sum of channels
        activation_sum_name = '%s/%s/img_%s_sum_iter_%s_plot_inter_activation_layer_%s.jpg' % (config['evals_root'],
                                                    experiment_name, img_index, state_dict['itr'], layer_index)
        ...
        one_ch_name = '%s/%s/img_%s_iter_%s_plot_inter_activation_layer_%s_onech.jpg' % (config['evals_root'],
                                                    experiment_name, img_index, state_dict['itr'], layer_index)
