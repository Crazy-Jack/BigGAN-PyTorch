...
--pbar tqdm \
--inference_nosample \
--experiment_name hypercolumn_sparse_implicit_recover_vc_sparse_comb_weight_sparse_maskoutput_regmask_4percent \
--sparsity_resolution 8_16_32_64 --sparsity_ratio 10_10_4_4 \
--save_weights \
--encoder Resnet-18 \
--sparsity_mode implicit_sparse_vc_recover_vcsparse_weight_sp_maskoutput \
--sparse_decay_rate 1e-3 \
--no_adaptive_tau \
--lambda_mask_loss_weights_complement 1 \
