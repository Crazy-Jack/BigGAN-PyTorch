#!/bin/bash
python3 ../../train.py \
--data_root /user_data/tianqinl/ImageNet/tiny-imagenet-200 \
--dataset tiny_imagenet --parallel --shuffle  --num_workers 32 --batch_size 36 \
...
--G_eval_mode \
--G_ch 64 --D_ch 64 \
--test_every 2000 --save_img_every 50 --save_model_every 100 --num_best_copies 5 --num_save_copies 1 --seed 0 \
