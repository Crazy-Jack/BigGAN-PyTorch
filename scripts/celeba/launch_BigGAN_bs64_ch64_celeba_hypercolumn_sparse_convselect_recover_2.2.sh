...
--pbar tqdm \
--inference_nosample \
--experiment_name hypercolumn_sparse_conv_sparse_vc_recover_mode_2.2 \
--sparsity_resolution 16 --sparsity_ratio 10 \
--save_weights \
--encoder Resnet-18 \
--sparsity_mode conv_sparse_vc_recover_no_sparse_mode_2.2 \
...
### LOG ###
# in 2.2 (compare with 2.0):
# only use 2 shallow self attention