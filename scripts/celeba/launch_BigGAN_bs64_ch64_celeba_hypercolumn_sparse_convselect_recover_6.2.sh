...
--pbar tqdm \
--inference_nosample \
--experiment_name hypercolumn_sparse_conv_sparse_vc_recover_mode_6.2 \
--sparsity_resolution 32 --sparsity_ratio 10 \
--save_weights \
--encoder Resnet-18 \
--sparsity_mode conv_sparse_vc_recover_no_sparse_mode_6.2 \
...
# compare with 6.0
# using vc to replace activation, adding loss to pull together vc and activation
