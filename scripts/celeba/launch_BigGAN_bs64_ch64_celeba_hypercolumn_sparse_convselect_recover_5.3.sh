...
--pbar tqdm \
--inference_nosample \
--experiment_name hypercolumn_sparse_conv_sparse_vc_recover_mode_5.3 \
--sparsity_resolution 32 --sparsity_ratio 10 \
--save_weights \
--encoder Resnet-18 \
--sparsity_mode conv_sparse_vc_recover_no_sparse_mode_5.3 \
...
### LOG ###
# in 5.3 (compare with 5.1(worry version, only max entropy of y, to make it not sparse...)):
# plan sparse layer on 32x32 layer
# regularize correct entropy of each class
