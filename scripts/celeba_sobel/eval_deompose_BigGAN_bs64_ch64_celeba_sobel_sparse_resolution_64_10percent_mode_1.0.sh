...
--pbar tqdm \
--inference_nosample \
--experiment_name sobel_sparse_resolution_64_10percent_mode_1.0 \
--sparsity_resolution 64 --sparsity_ratio 10 \
--save_weights \
--encoder Resnet-18 \
--sparsity_mode gradient_topk_mode_1.0 \
